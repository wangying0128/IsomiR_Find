...
if(system("perl 9.pl r1.txt r2.txt r3.txt r4.txt r5.txt r6.txt r7.txt  isoform_3_3_0.txt")){
      print "Fatal Error : in 9.pl\n";
        exit(1);
}
`sort isoform_3_3_0.txt >isoform_3_3_1.txt`;
system("perl 10_filter.pl isoform_5_3_1.txt isoform_3_3.txt");
system("rm -f isoform_3_3_1");
system("rm -f isoform_3_3_0");
system("rm -f hg1.txt");
system("rm -f hg2.txt");
system("rm -f hg3.txt");
system("rm -f hg4.txt");
