...
if(system("perl 9_result.pl miRNA1_rev.txt 5_pre_miRNA_snp.txt test_1.txt.str test1_negative1.txt negative_num.txt $out_file_1  $out_file_2")){
       print "Fatal Error : 9_result.pl\n";
       exit(1);
}
if(system("perl 10_position.pl result2.txt hsa_posi_5.txt result3.txt")){
